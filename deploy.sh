...
# main config
PLUGINSLUG="bootstrap-shortcoder"
CURRENTDIR=`pwd`
MAINFILE="bootstrap-shortcoder.php" # this should be the name of your main php file in the wordpress plugin
...
SVNURL="http://plugins.svn.wordpress.org/bootstrap-shortcoder" # Remote SVN repo on wordpress.org, with no trailing slash
